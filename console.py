...
class HBNBCommand(cmd.Cmd):
    ...
    def default(self, line):
        """This is the catch commands if nothing else matches then"""
        # print("DEF:::", line)
        self._precmd(line)

    def _precmd(self, line):
        """This intercept commands to test for class.syntax()"""
        # print("PRECMD:::", line)
    ...
    def do_EOF(self, line):
        """This will handle End Of File character
        """
        print()
        return True
    ...
    def do_destroy(self, line):
        """This will delete an instance based on the class name and id
        """
        if line == "" or line is None:
            print("** class name missing **")
        else:
