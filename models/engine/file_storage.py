...
class FileStorage:
    ...
    def new(self, obj):
        """This will set in __objects the obj with key <obj class name>.id"""
    ...
    def classes(self):
        """This will return a dictionary of valid classes and their references"""
    ...
    def reload(self):
        """This will reload the stored objects"""
    ...
    def attributes(self):
        """This will return the valid attributes and
